...
RUN /opt/steam/steamcmd.sh +login $steam_user $steam_password +force_install_dir /opt/hlds +app_update 90 validate +app_update 90 validate +app_update 90 validate +app_update 90 validate +quit
